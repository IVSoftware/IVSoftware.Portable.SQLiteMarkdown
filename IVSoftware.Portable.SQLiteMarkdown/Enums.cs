...
namespace IVSoftware.Portable.SQLiteMarkdown
{
    ...
    {
        /// <summary>
        /// Enables partial matching in the **database query phase** using SQLite LIKE expressions.
        /// This allows retrieval of records where the term appears anywhere within the property value,
        /// e.g., a search for "book" could match "notebook" or "booking."
        /// </summary>
        LikeTerm = 0x01,

        /// <summary>
        /// Enables broad in-memory filtering in the **filter phase**. After the initial query, this
        /// option allows properties to be included in full-text searches, matching any occurrence of 
        /// a term in each property.
        /// </summary>
        ContainsTerm = 0x02,
