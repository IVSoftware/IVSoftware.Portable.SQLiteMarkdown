...
{
    internal class ObservablePreviewCollectionOR<T> : ObservableCollection<T>
    {
        public ObservablePreviewCollectionOR(NotifyCollectionChangeScope eventScope = NotifyCollectionChangeScope.CancelOnly)
        {
